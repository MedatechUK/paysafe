...
Private _threeDEnrollment As String
''' <summary> 
...
''' </summary> 
''' <returns></returns> 
Public Property [threeDEnrollment] As String 
Get 
...
Private _threeDResult As String
''' <summary> 
...
''' </summary> 
''' <returns></returns> 
Public Property [threeDResult] As String 
Get 
...
Private _signatureStatus As String
''' <summary> 
