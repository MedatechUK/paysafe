Namespace PaySafe.Payment
    ...
    Public Class [shippingDetails] : Implements IDisposable
        ...
        ''' </summary> 
        ''' <returns></returns> 
        Public Property [carrier] As tcarrier
            Get
                Return _carrier
            End Get
            Set(value As tcarrier)
                _carrier = value
            End Set
        End Property

        Private _shipMethod As tshipMethod
        ''' <summary> 
        ...
        ''' </summary> 
        ''' <returns></returns> 
        Public Property [shipMethod] As tshipMethod
            Get
                Return _shipMethod
            End Get
            Set(value As tshipMethod)
                _shipMethod = value
            End Set
        End Property
        ...
        Private _country As Constant.ISO.tCountry
        ''' <summary> 
        ''' See�Country Codes.
        ''' </summary> 
        ''' <returns></returns> 
        Public Property [country] As Constant.ISO.tCountry
            Get
                Return _country
            End Get
            Set(value As Constant.ISO.tCountry)
                _country = value
            End Set
        End Property
