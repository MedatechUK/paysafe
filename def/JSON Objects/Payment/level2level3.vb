...
Private _exemptLocalTax As String
''' <summary> 
...
''' </summary> 
''' <returns></returns> 
Public Property [exemptLocalTax] As String 
Get 
...
Private _localTaxAmount As String
''' <summary> 
''' This is the local sales tax applied to the purchase.
''' 
''' </summary> 
''' <returns></returns> 
Public Property [localTaxAmount] As String 
Get 
