Namespace PaySafe
    Public Class profiles : Implements IDisposable
        ...
        Private _locale As Constant.tlocale
        ''' <summary> 
        ...
        ''' </summary> 
        ''' <returns></returns> 
        Public Property locale As Constant.tlocale
            Get
                Return _locale
            End Get
            Set(value As Constant.tlocale)
                _locale = value
            End Set
        End Property
        ...
        Private _gender As Constant.tGender
        ''' <summary> 
        ...
        ''' </summary> 
        ''' <returns></returns> 
        Public Property gender As Constant.tGender
            Get
                Return _gender
            End Get
            Set(value As Constant.tGender)
                _gender = value
            End Set
        End Property
